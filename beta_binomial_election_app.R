...
##
## Your answer:
## alpha: 180, beta: 120, mean: 0.600, confidence: between 54% and 65%
##
## ------------------------------------------------------------
...
##
## Your answer:
## there is a higher confidence in the statistics because of a larger sample size
##
## ------------------------------------------------------------
...
##
## Your answer:
## the flat prior has no single mode because there is complete uncertainty as to the results. 
## the 0.5,0.5 beta is bimodal and the density piles up at the 0 end and 1 end but the mean remains 0.5
## the next entry will either make the entire graph a 0 or 1.
## ------------------------------------------------------------
...
##
## Your answer: 
## Since the flat prior is completely uncertain it doesn't affect the scaled outcome significantly 
##
##
## ------------------------------------------------------------
...
##
## Your answer: The weight of the new data, because of it's much larger sample size 
## much more strongly affects the Posterior than the Prior does. It is still affected by the prior
## though which means it takes a large weight towards the new data to overrule the prior
##
##
## ------------------------------------------------------------
...
##
## Your answer: The Bayesian credible interval can say that the mean is 
## somewhere in a distribution while the frequentist model can't say anything about where the 
## next vote will be. 
## 
##
##
